...
| --- | --- | --- |
| `top-bottom` | user-confirmed whole canvas | one complete generation: high-fidelity source above, 031 design below, approximately 50/50 |
| `left-right` | user-confirmed whole canvas | one complete generation: high-fidelity source left, 031 design right, approximately 50/50 |
| `design-only` | user-confirmed whole canvas | 031 design fills the canvas; source remains invisible |
