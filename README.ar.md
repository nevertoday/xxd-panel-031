...
لهذا الإحباط صنعت **Panel 031**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **يختزل الصورة إلى رمز هندسي واحد تقوده الدلالة ويحمل أثر الطباعة الشعبية**.
