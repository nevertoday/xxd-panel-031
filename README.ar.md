...
| --- | --- | --- |
| `top-bottom` | متكيف مع المصدر | الصورة كاملة في الأعلى ورسم 031 الهندسي ذي الأثر الشعبي في الأسفل؛ يحتفظ اللوحان بالمقاس وينقسمان 50/50 بدقة |
| `left-right` | متكيف مع المصدر | الصورة كاملة في اليسار ورسم 031 الهندسي ذي الأثر الشعبي في اليمين؛ يحتفظ اللوحان بالمقاس وينقسمان 50/50 بدقة |
...
الأولوية هي: البكسلات الدقيقة التي يحددها المستخدم، ثم النسبة أو الوجهة، ثم التكيف مع المصدر في الأنماط العادية. نسبة 3:4 في ملف `031.md` كانت لوحة إبداعية أولى وليست قيمة افتراضية صامتة في المهارة الحالية.
...
- **أربعة أعمال مستقلة:** يرجع كل جهاز إلى الصورة الأصلية وحدها، ويستكشف مقياساً مختلفاً للرمز واقتطاعاً هندسياً وعلاقة فراغ سالب ونسب الحبر وكثافة الأثر ومحاذاة النص.
...
ينشئ نموذج الصور الرمز المركزي الحامل للمعنى، والأصل الهندسي المشتق من المصدر، والمحيط والفراغ السالب الدقيقين، وهرمية الحبر الواضحة، وأثر الحفر الخشبي والطباعة الجافة داخل الأشكال، والفراغ الصريح، والنص التحريري التابع باللغة المستهدفة. ولا يتولى `scripts/compose_panel.py` سوى تخطيط اللوحة والتركيب النقطي الدقيق بنسبة 50/50 وتثبيت المقاس والمراجعة؛ ولا يرسم العمل برمجياً.
